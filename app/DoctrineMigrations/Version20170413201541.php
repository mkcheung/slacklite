 ...
 */
class Version20170413201541 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE message (message_id SERIAL NOT NULL, created_by_id INT DEFAULT NULL, user_id INT DEFAULT NULL, message TEXT NOT NULL, createdAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modifiedAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(message_id))');
        ...
        $this->addSql('CREATE TABLE message_user (user_id SERIAL NOT NULL, role_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, createdAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modifiedAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(user_id))');
        $this->addSql('CREATE INDEX IDX_24064D90D60322AC ON message_user (role_id)');
        $this->addSql('CREATE TABLE role (role_id SERIAL NOT NULL, type VARCHAR(255) NOT NULL, createdAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modifiedAt TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(role_id))');
